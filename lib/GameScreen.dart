                              ...
                              child: Padding(
                                ...
                                child: Align(
                                  ...
                                  child: AutoSizeText(onTapVal.toString(),
                                      ...
                                      style: GoogleFonts.pressStart2p(
                                          textStyle: TextStyle(
                                              color: rewardVisible?Color(0xffffc107):Colors.white, fontSize: 16))),
                                ),
                              ),
                            ),
                          ],
  ...
  void tapPrestige() {
    showDialog(
        ...
        builder: (_) => new AlertDialog(
          ...
          content: new Text("This will upgrade you to the next level, resetting your current progress."),
          actions: <Widget>[
            TextButton(
              child: Text('Close'),
              onPressed: () {
